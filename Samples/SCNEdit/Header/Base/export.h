...
#include "Header/Base/CScnSolid.h"
 ...
 #define TRI_VERTEXL   0x1041
 #define TRI_FACEL2    0x1141
 #define TRI_FACEL1    0x2041
...
void scnExport3ds(CScnSolid * scn, u32 totalSize, const char * name);
